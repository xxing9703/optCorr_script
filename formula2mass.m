% This function calculates the monoisotopic mass of a substance and number of each element.
...
for i=1:length(substance_symbol)
    substance_symbol{i}=strcat(substance_symbol{i}');
end

info=[substance_symbol',num2cell(substance_mass'),num2cell(factor')];

count=[0 0 0 0 0 0 0 0 0];
symbols={'C','N','H','O','S','P','F','Cl','Br'};
